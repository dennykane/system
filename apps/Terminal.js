...
*/
//»
/*"Importing" command libraries via com_import is a deprecated solution.«
...
library in mods/coms/, but just without the ending '.js'. This is a very
...
//		editor.set_stat_message("Really close the window? [y/N]");
		editor.stat_message="Really close the window? [Y/n]";
		render();
